...
<body>
    ...
    <div class="container">
        <div class="card">
            <img src="chocolates.png" alt="Snacks">
            <h3>Dairy Milk Silk</h3>
            <p>₹80</p>
            <button onclick="openCartModal('chocolates.png', 'Dairy Milk Silk', 80)">Add to Cart</button>
        </div>
	<div class="card">
            <img src="chocolates.png" alt="Snacks">
            <h3>Kit Kat</h3>
            <p>₹30</p>
            <button onclick="openCartModal('chocolates.png', 'Kit Kat', 30)">Add to Cart</button>
        </div>
	<div class="card">
            <img src="chocolates.png" alt="Snacks">
            <h3>Center Fresh</h3>
            <p>₹1</p>
            <button onclick="openCartModal('chocolates.png', 'Center Fresh', 1)">Add to Cart</button>
        </div>
	<div class="card">
            <img src="chocolates.png" alt="Snacks">
            <h3>Mango Bite</h3>
            <p>₹2</p>
            <button onclick="openCartModal('chocolates.png', 'Mango Bite', 2)">Add to Cart</button>
        </div>
	<div class="card">
            <img src="chocolates.png" alt="Snacks">
            <h3>Polo</h3>
            <p>₹20</p>
            <button onclick="openCartModal('chocolates.png', 'Polo', 20)">Add to Cart</button>
        </div>
