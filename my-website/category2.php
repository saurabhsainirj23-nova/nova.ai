...
<body>
    ...
    <div class="container">
        <div class="card">
            ...
            <h3>Snacks 1</h3>
            <p>₹20</p>
            <button onclick="openCartModal('snacks.png', 'Snacks 1', 20)">Add to Cart</button>
        </div>
	<div class="card">
            <img src="snacks.png" alt="Snacks">
            <h3>Snacks 2</h3>
            <p>₹30</p>
            <button onclick="openCartModal('snacks.png', 'Snacks 2', 30)">Add to Cart</button>
        </div>
	<div class="card">
            <img src="snacks.png" alt="Snacks">
            <h3>Snacks 3</h3>
            <p>₹10</p>
            <button onclick="openCartModal('snacks.png', 'Snacks 3', 10)">Add to Cart</button>
        </div>
	<div class="card">
            <img src="snacks.png" alt="Snacks">
            <h3>Snacks 4</h3>
            <p>₹40</p>
            <button onclick="openCartModal('snacks.png', 'Snacks 4', 40)">Add to Cart</button>
        </div>
	<div class="card">
            <img src="snacks.png" alt="Snacks">
            <h3>Snacks 5</h3>
            <p>₹60</p>
            <button onclick="openCartModal('snacks.png', 'Snacks 5', 60)">Add to Cart</button>
        </div>
