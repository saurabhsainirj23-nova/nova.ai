...
<body>
    ...
    <div class="container">
        <div class="card">
            <img src="https://sslimages.shoppersstop.com/sys-master/images/h67/h91/30199487201310/4706729_UNMAPPED.jpg_2000Wx3000H" alt="Snacks">
            <h3>perfume 1</h3>
            <p>₹120</p>
            <button onclick="openCartModal('perfumes.jpg', 'perfume 1', 120)">Add to Cart</button>
        </div>
	<div class="card">
            <img src="https://sslimages.shoppersstop.com/sys-master/images/h67/h91/30199487201310/4706729_UNMAPPED.jpg_2000Wx3000H" alt="Snacks">
            <h3>perfume 2</h3>
            <p>₹100</p>
            <button onclick="openCartModal('perfumes.jpg', 'perfume 2', 100)">Add to Cart</button>
        </div>
	<div class="card">
            <img src="https://sslimages.shoppersstop.com/sys-master/images/h67/h91/30199487201310/4706729_UNMAPPED.jpg_2000Wx3000H" alt="Snacks">
            <h3>perfume 3</h3>
            <p>₹90</p>
            <button onclick="openCartModal('perfumes.jpg', 'perfume 3', 90)">Add to Cart</button>
        </div>
	<div class="card">
            <img src="https://sslimages.shoppersstop.com/sys-master/images/h67/h91/30199487201310/4706729_UNMAPPED.jpg_2000Wx3000H" alt="Snacks">
            <h3>perfume 4</h3>
            <p>₹130</p>
            <button onclick="openCartModal('perfumes.jpg', 'perfume 4', 130)">Add to Cart</button>
        </div>
	<div class="card">
            <img src="https://sslimages.shoppersstop.com/sys-master/images/h67/h91/30199487201310/4706729_UNMAPPED.jpg_2000Wx3000H" alt="Snacks">
            <h3>perfume 5</h3>
            <p>₹150</p>
            <button onclick="openCartModal('perfumes.jpg', 'perfume 5', 150)">Add to Cart</button>
        </div>
