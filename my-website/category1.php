...
<body>
    ...
    <div class="container">
        <div class="card">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRHpvAX1VwMBvaHesEosoJAZf6Ye2bDGzoYCQ&s" alt="Ice Cream">
            <h3>Ice Cream 1</h3>
            <p>₹65</p>
            <button onclick="openCartModal('ice_cream.jpg', 'Ice Cream 1', 65)">Add to Cart</button>
        </div>
	<div class="card">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRHpvAX1VwMBvaHesEosoJAZf6Ye2bDGzoYCQ&s" alt="Snacks">
            <h3>Ice Cream 2</h3>
            <p>₹10</p>
            <button onclick="openCartModal('ice_cream.jpg', 'Ice Cream 2', 10)">Add to Cart</button>
        </div>
	<div class="card">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRHpvAX1VwMBvaHesEosoJAZf6Ye2bDGzoYCQ&s" alt="Snacks">
            <h3>Ice Cream 3</h3>
            <p>₹35</p>
            <button onclick="openCartModal('ice_cream.jpg', 'Ice Cream 3', 35)">Add to Cart</button>
        </div>
	<div class="card">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRHpvAX1VwMBvaHesEosoJAZf6Ye2bDGzoYCQ&s" alt="Snacks">
            <h3>Ice Cream 4</h3>
            <p>₹60</p>
            <button onclick="openCartModal('ice_cream.jpg', 'Ice Cream 4', 60)">Add to Cart</button>
        </div>
	<div class="card">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRHpvAX1VwMBvaHesEosoJAZf6Ye2bDGzoYCQ&s" alt="Snacks">
            <h3>Ice Cream 5</h3>
            <p>₹100</p>
            <button onclick="openCartModal('ice_cream.jpg', 'Ice Cream 5', 100)">Add to Cart</button>
        </div>
